...
public class bufferTest {
	public static void main (String[] args) {
		...
		driver.get("https://getmiclass.manipalgroup.info/gmccodez/html/videocheck/");
...
//		driver.manage().window().maximize();
		...
		//WebElement playButton = driver.findElement(By.xpath("//html/body/video/source[@src=\"video.php?video=HomeLoans.mp4\"]"));
		//WebElement playButton = driver.findElement(By.xpath("//button[@aria-label=\"Play\"]"));
		WebElement playButton = driver.findElement(By.xpath("//video"));
		playButton.click();
